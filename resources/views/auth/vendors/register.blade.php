        ...
        <div class="col-md-6 offset-md-3">
            ...
            <div class="card my-5">
                ...
                <form class="card-body cardbody-color p-lg-5" method="POST" action="{{route('vendors.handleRegister')}}">
                    ...
                    <div class="mb-3">
                        <input type="text" name="name" class="form-control" id="name" placeholder="Nom du vendeur" value="{{old('name')}}">
                        @error('name')
                    ...
                    <div id="emailHelp" class="form-text text-center mb-5 text-dark">Déjà inscrit?? <a href="{{route('vendors.login')}}" class="text-dark fw-bold">Connectez-vous </a>
                    </div>
                </form>
            </div>
